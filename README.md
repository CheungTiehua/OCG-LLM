...
* **Top-down: Protocol-as-System (PaS)** System behavior is governed by explicit, non-bypassable, and auditable **Declarative Protocols**.  
    **自上而下：协议即系统 (PaS)** —— 系统行为由显式、不可绕过且可审计的“声明式协议”统一裁定。

* **Bottom-up: Operational Closure (OCG/DOC)** Achieving generative stability through **Topological Contraction**. By applying Declarative Operational Closure (DOC), we induce a Probabilistic Stable Operational State (PSOS).  
...
We formalize the interaction as:  
我们通过以下算式将其形式化：
...
* **[/Papers](./Papers)**: 
    * **[Protocol-as-System (PDF)](./Papers/Protocol_as_System：A_Declarative_Protocol_Computing_Paradigm_for_Auditable_AI_Generation.docx)** - 协议即系统范式全文
    * **[Operational-Closure (PDF)](./Papers/Operational_Closure_and_Generative_Topological_Contraction.docx)** - 底层数学/拓扑理论全文
...
> **Cheung, T. (2026).** *Protocol-as-System: A Declarative Protocol Computing Paradigm for Auditable AI Generation.* GitHub: `https://github.com/你的用户名/Protocol-as-System`
